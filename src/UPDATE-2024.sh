...
#OMEGA
python3 getFastaFromGB.py O > updating_2024

bash update.sh db_Omegatorquevirus
mv no_sp.fa UNCLASS/UNCLASS-Omega.fa

#HE
python3 getFastaFromGB.py H > updating_2024
