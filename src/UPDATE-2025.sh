...
python3 getFastaFromGB.py -1 > updating_2025
python3 getFastaFromGB.py -2 >> updating_2025
...
cat no_ABG.fa >> updating_2025
rm no_ABG.fa

bash update.sh db_Hetorquevirus 68 TRUE
mv no_sp.fa updating_2025
...
rm updating_2025
mv Alpha-A.fa updating_2025
bash update.sh db_Alphatorquevirus-A 68 TRUE        
mv no_sp.fa UNCLASS/UNCLASS-Alpha-A.fa
